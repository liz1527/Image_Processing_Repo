...
#    hdr5 = im05Bfull[0].header
    ...
    ### Create test image ###
    im05B = np.zeros([1000,1000])
    im05B[0:500,0:500] = 1 #BL
    im05B[0:500,500:1000] = 2 #TL
    im05B[500:1000,0:500] = 3 #BR
    im05B[500:1000, 500:1000] = 4 #TR
    plt.figure()
    plt.imshow(im05B)
    plt.scatter(quad1data['X_IMAGE_'+sem],quad1data['Y_IMAGE_'+sem])
